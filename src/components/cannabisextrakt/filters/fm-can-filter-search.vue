<template>
    <div class="fm-can-search-element input-group mb-3">
        <input id="fm-can-search-input" :value="value" type="text" class="form-control" :placeholder="placeholder" :aria-label="placeholder" aria-describedby="basic-addon"  @focus="setFocusBlock($event)" @blur="removeFocusBlock($event)" @input="setSearch($event.target.value)">
