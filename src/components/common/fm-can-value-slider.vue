<template>
	...
	<div class="fm-can-slider-count-block">
		...
		<input type="number" :value="value" :min="sliderparams.startvalue" :max="sliderparams.endvalue" :disabled="sliderparams.disabled"
	...
	<div class="fm-can-slider">
		...
		<el-slider :model-value="value1" :show-tooltip="false" :min="sliderparams.startvalue" :disabled="sliderparams.disabled"
			:max="sliderparams.endvalue" :step="Number(sliderparams.step)" @input="onInput($event)" @change="onMouseUp">
		</el-slider>
...
/* .fm-can-slider-count-block:focus{
